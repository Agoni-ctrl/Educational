...
<template>
  <div class="about-page">
    ...
    <main>
      ...
      <section class="block">
        <h2 class="block__title">我们的理念</h2>
      ...
      <section class="block block--competition">
...
.quote-card {
  ...
  box-shadow: 0 16px 48px rgba(0, 87, 217, 0.06);
}
...
.team-card:hover {
  ...
  box-shadow: 0 12px 36px rgba(10, 15, 26, 0.06);
}
